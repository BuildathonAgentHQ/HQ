            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <Card className="bg-white/5 border-white/10 col-span-full md:col-span-2 lg:col-span-3 min-h-[400px] flex items-center justify-center">
                    <CardContent className="flex flex-col items-center gap-4 text-center p-12">
                        ...
                        <CardTitle className="text-xl">Budget Burn Pending</CardTitle>
                        <CardDescription className="max-w-md">
                            The FinOps dashboard explicitly tracks budget burn, input/output token usage per engine,
                            and cumulative ROI for autonomous task completion.
                        </CardDescription>
                    </CardContent>
                </Card>
            </div>
